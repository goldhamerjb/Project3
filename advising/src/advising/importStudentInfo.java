...
public void importBasicInfo(File stuInfo, LinkedList<String>  tree)
...
public void importFullInfo(File stuInfo, LinkedList<String>  tree) //used to import a file with the full information(inculdes advising info)
	{
	File studentInformation = stuInfo;
	Scanner infoReader = null;
